...
CREATE TABLE IF NOT EXISTS samples (
  ...
  description TEXT,                -- party intro / author note (shown in gallery)
  created_at  INTEGER NOT NULL     -- epoch millis
);

-- Per-user cloud store for saved teams (survives logout / syncs across devices).
CREATE TABLE IF NOT EXISTS user_teams (
  user_id    TEXT PRIMARY KEY,
  data       TEXT NOT NULL,        -- JSON array of Team objects
