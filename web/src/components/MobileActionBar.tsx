...
export default function MobileActionBar({ children }: { children: ReactNode }) {
  return (
    <div className="flex flex-wrap items-center gap-2 max-lg:fixed max-lg:inset-x-0 max-lg:bottom-[calc(3.5rem+env(safe-area-inset-bottom))] max-lg:z-30 max-lg:mx-auto max-lg:max-w-6xl max-lg:flex-nowrap max-lg:overflow-x-auto max-lg:border-t max-lg:border-zinc-200/70 max-lg:bg-white/95 max-lg:px-4 max-lg:py-2.5 max-lg:shadow-[0_-6px_20px_rgba(0,0,0,0.10)] dark:max-lg:border-white/8 dark:max-lg:bg-surface-dark/95">
      {children}
    </div>
  )
}
