...
| 10 | 품질 안정화(검색 실시간·반응형 텍스처 깨짐·한/영 표기·특성 누락 버그) | ✅ 완료 |
| 11 | 배틀 데이터(사용률·채용률·상위 덱 분석) + 유저 가공 도구 | ✅ 완료 |
| 12 | 커뮤니티 운영(신고·관리자 대시보드·유저 경고/차단·공지 게시판) | ✅ 완료 |
| 13 | 후원 안내 + 기업 수준 상세 정책(약관·개인정보·규정) | ✅ 완료 |
| 14 | 안드로이드 앱 (Capacitor+AdMob) + Play 스토어 출시 | ⬜ 일부 완료 |
